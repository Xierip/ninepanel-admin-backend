...
class HostingController {
  ...
  @RequiresAuthenticated
  @PutMapping("{hostingId}")
  ResponseEntity<HostingDto> update(@PathVariable ObjectId hostingId, @Valid @RequestBody HostingDto hostingDto) {
    return ResponseEntity.ok(hostingFacade.update(hostingId, hostingDto));
  }

  @RequiresAuthenticated
  @DeleteMapping("{hostingId}")
  ResponseEntity<?> delete(@PathVariable ObjectId hostingId) {
    hostingFacade.delete(hostingId);
